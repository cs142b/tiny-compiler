use crate::{
    basic_block::{BasicBlock, VariableType},
...
impl Program {
    ...
    pub fn assign_variable_to_curr_block(&mut self, var_name: &String, var: VariableType) {
        self.get_curr_block_mut().assign_variable(&var_name, var);
    }
